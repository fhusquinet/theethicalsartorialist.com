    ...
    <div class="container px-4">
        <div class="flex items-center justify-between flex-wrap">
            ...
            <div class="flex items-center w-auto md:hidden">
                <a href="#" class="py-4">
                    <img src="{{ asset('icons/hamburger.svg') }}" class="h-8" alt="Menu" />
                </a>
            </div>
            <div class="items-center w-auto hidden md:flex">
                <a href="#responsive-header" class="block py-6 lg:inline-block lg:mt-0 text-grey-dark hover:text-primary-darker transition--fast ml-4 no-underline">
                    Docs
                </a>
                <a href="#responsive-header" class="block py-6 lg:inline-block lg:mt-0 text-grey-dark hover:text-primary-darker transition--fast ml-4 no-underline">
                    Examples
