...
@section ('content-container')
    ...
    @component ('pages._partials.section-img-left', ['class' => ''])
        @slot ('image')
            [image id=137]
            <p class="text-grey font-thin text-sm mt-2">Photo by elCarito on Unsplash</p>
        @endslot
        @slot ('text')
            <h3 class="text-grey-dark font-thin leading-loose mb-4 text-2xl lg:text-3xl">The human and social aspect</h3>
    ...
    @component ('pages._partials.section-img-right')
        @slot ('image')
            [image class="img-cover b-lazy"  id=135]
            <p class="text-grey font-thin text-sm mt-2">Photo by zoltantasi on Unsplash</p>
        @endslot
        @slot ('text')
            <h3 class="text-grey-dark font-thin leading-loose mb-4 text-2xl lg:text-3xl">The animal welfare</h3>
            <p class="text-grey font-thin leading-loose mb-2">
    ...
    @component ('pages._partials.section-img-left', ['class' => ''])
        @slot ('image')
            [image class="img-cover b-lazy"  id=136]
            <p class="text-grey font-thin text-sm mt-2">Photo by Jason Blackeye on Unsplash</p>
        @endslot
        @slot ('text')
            <h3 class="text-grey-dark font-thin leading-loose mb-4 text-2xl lg:text-3xl">The environmental impact</h3>
            <p class="text-grey font-thin leading-loose mb-2">
    ...
    @component ('pages._partials.section-img-right')
        @slot ('image')
            [image class="img-cover b-lazy"  id=138]
            <p class="text-grey font-thin text-sm mt-2">Photo by Fancycrave on Unsplash</p>
        @endslot
        @slot ('text')
            <h3 class="text-grey-dark font-thin leading-loose mb-4 text-2xl lg:text-3xl">Slow fashion</h3>
            <p class="text-grey font-thin leading-loose mb-2">
