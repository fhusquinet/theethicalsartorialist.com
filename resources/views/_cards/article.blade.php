<div class="relative card card__image card--article {{ $class ?? '' }} group shadow hover:shadow-blur">
    
    <a href="{{ url('/article') }}" class="absolute pin">Article title</a>
    
    <div class="card__image card--article__image relative overflow-hidden">
        <div class="card__image__background bg-cover bg-center transition--fast" style="background-image: url({{ asset('images/articles/1.jpg') }})"></div>
